...
import { WebSocketAuthMiddleware } from './modules/auth/presentation';
import { WebSocketController } from './modules/qr-projection/presentation/websocket-controller';
import { registerEnrollmentRoutes } from './modules/enrollment/presentation/routes';
import { registerSessionModule } from './modules/session/session.module';

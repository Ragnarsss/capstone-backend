...
## Pendiente para Día 3-5

**Día 3 - Integración Legacy:**

1. Migración endpoint `api_get_asistencia_token.php`
   - Actualizar horario.php y main_curso.php
   - Apuntar a Node.js backend en vez de PHP legacy
   - Validar flujos profesor y estudiante

**Día 4-5 - Testing Avanzado:**

2. Definir framework de testing E2E e integración

   - Evaluar: Playwright vs Cypress vs Puppeteer (E2E browser)
   - Evaluar: Vitest+fetch vs Supertest (integración HTTP)
   - Documentar decisión en ESTRATEGIA_AUTOMATIZACION_TESTS.md

3. Implementar tests de integración HTTP para PHP Service

   - CORS headers con diferentes orígenes
   - OPTIONS preflight handling
   - Rate limiting (429 responses)
   - Session validation flow completo
   - **Objetivo:** Aumentar cobertura PHP de 58.28% a ~75%
...
5. Validación de 7 requisitos funcionales
6. Ajustes post-validación
...
**Siguiente Jornada:** 2026-01-03 - Migración endpoints legacy
